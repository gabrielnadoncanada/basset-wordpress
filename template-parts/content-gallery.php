...
<?php if (is_single()) : ?>
    ...
    <?php } else { ?>
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class('blog-post-item blog-details-wrap format-gallery'); ?>>

            <?php if (has_post_thumbnail()) : ?>
                <div class="blog__details-thumb blog-post-thumb-active">
...
<?php else : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('blog-post-item post type-post panel vstack gap-3 rounded-2 p-3 pb-4 bg-secondary dark:bg-gray-300 dark:bg-opacity-10 format-gallery'); ?>>

        <?php if (!empty($gallery_images)) : ?>
            <div class="blog-post-thumb blog-post-thumb-active">
                <?php foreach ($gallery_images as $key => $image) :  ?>
                    <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>">
                <?php endforeach; ?>
            </div>
