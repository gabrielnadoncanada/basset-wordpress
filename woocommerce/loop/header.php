...
?>
<header class="woocommerce-products-header shop-header panel vstack justify-center mb-2 lg:mb-6 text-center">
    <?php
    /**
    ...
    ?>
        <h1 class="woocommerce-products-header__title page-title h3 lg:h1 m-0"><?php woocommerce_page_title(); ?></h1>
    <?php endif; ?>
